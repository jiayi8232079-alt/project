...
define source-static-intermediate
$(strip	\
	$(patsubst $(_XMAKE_TOPDIR)/%,$(_XMAKE_OBJS_DIR)/static/%.i,$(abspath $(1)))
)
endef
...
define build-intermediate
	echo "CC $(2)";
	#echo "CC $(CFLAGS) $(1) -o $@ -E $<"
	mkdir -p $(dir $(1));
	$(CC) $(CFLAGS) $(3) -D_THIS_FILE_NAME_=\"$(notdir $(2))\" -o $(1) -E $(2) || ( echo "compile command:"; echo "$(CC) $(CFLAGS) $(3) -o $(1) -E $(2)"; false )
endef

define build-cxx-object
	echo "CXX $(2)";
	#echo "CXX $(CXXFLAGS) $(1) -o $@ -c $<"
	mkdir -p $(dir $(1));
	$(CXX) $(CXXFLAGS) $(3) -o $(1) -c $(2) || ( echo "compile command:"; echo "$(CXX) $(CXXFLAGS) $(3) -o $(1) -c $(2)"; false )
	$(CXX) $(CXXFLAGS) $(3) -MM $(2) -MT $(1) > $(1).d
endef

define build-cxx-intermediate
	echo "CXX $(2)";
	#echo "CXX $(CXXFLAGS) $(1) -o $@ -E $<"
	mkdir -p $(dir $(1));
	$(CXX) $(CXXFLAGS) $(3) -o $(1) -E $(2) || ( echo "compile command:"; echo "$(CXX) $(CXXFLAGS) $(3) -o $(1) -E $(2)"; false )
endef
...
#静态编译规则
$(_XMAKE_OBJS_DIR)/static/%.c.i: $(_XMAKE_TOPDIR)/%.c
	@$(call build-intermediate,$@,$<,$(XMAKE_STATIC_CFLAGS) $(PRIVATE_CFLAGS))

$(_XMAKE_OBJS_DIR)/static/%.cpp.i: $(_XMAKE_TOPDIR)/%.cpp
	@$(call build-cxx-intermediate,$@,$<,$(XMAKE_STATIC_CFLAGS) $(PRIVATE_CFLAGS))

$(_XMAKE_OBJS_DIR)/static/%.cc.i: $(_XMAKE_TOPDIR)/%.cc
	@$(call build-cxx-intermediate,$@,$<,$(XMAKE_STATIC_CFLAGS) $(PRIVATE_CFLAGS))
