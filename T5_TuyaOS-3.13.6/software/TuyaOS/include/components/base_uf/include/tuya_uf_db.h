...
/**
 * @brief enter ufwrite raw mode
 *
 * @param[in] fd the file handle
 * @return OPRT_OK on success. Others on error, please refer to tuya_error_code.h
 * @note all ufwrite operation chould cause data loss before ufwrite_raw_end() invoked
 */
UINT_T ufwrite_raw_start(IN uFILE *fd);

/**
 * @brief Exit ufwrite raw mode
 *
 * @param[in] fd the file handle
 * @return OPRT_OK on success. Others on error, please refer to tuya_error_code.h
 * @note all ufwrite operation chould cause data loss before ufwrite_raw_end() invoked
...
OPERATE_RET ufmkdir(CHAR_T* path, BOOL_T recursive);
OPERATE_RET ufrmdir(CHAR_T* path, BOOL_T recursive);
