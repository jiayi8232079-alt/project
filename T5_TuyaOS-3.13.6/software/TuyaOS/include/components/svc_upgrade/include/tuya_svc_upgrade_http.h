...
OPERATE_RET http_device_upgrade_info_matter_get(const DEV_TYPE_T tp, UINT16_T vid, UINT16_T pid,
                                                UINT32_T req_ver, const CHAR_T *fw_key, const CHAR_T *chn_ver,
                                                ty_cJSON **result);
#endif
