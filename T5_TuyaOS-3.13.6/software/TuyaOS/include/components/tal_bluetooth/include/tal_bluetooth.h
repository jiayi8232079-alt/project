 ...
 *          ERROR
 * */ 
OPERATE_RET tal_ble_ext_advertising_config(TAL_BLE_EXT_ADV_T ext_adv, TAL_BLE_EXT_ADV_PARAMS_T CONST *p_adv_params, 
                                       TAL_BLE_DATA_T CONST *p_adv_data, TAL_BLE_DATA_T CONST *p_scan_rsp);
...
/**
 * @brief   [Ble Peripheral] Indicate Command characteristic value by handle
 * @param   [in] index: char index
 * @param   [in] p_data: pointer to data, refer to TAL_BLE_DATA_T
 * @return  SUCCESS
 *          ERROR Refer to platform error code
 * */
OPERATE_RET tal_ble_server_common_indicate(USHORT_T index, TAL_BLE_DATA_T *p_data);
