...
typedef VOID (*TY_GW_BLE_EVENT_CB)(TAL_BLE_EVT_PARAMS_T *p_event);
typedef struct {
    TAL_BLE_ROLE_E     ble_role;
    TY_GW_BLE_EVENT_CB ble_event_cb;
} TUYA_GW_BLE_PARA;
VOID_T tuya_gw_ble_set_params(TUYA_GW_BLE_PARA* para);
...
void tuya_ble_parse_scan_info(TAL_BLE_ADV_REPORT_T *scan_info);
#endif
#endif
#ifdef __cplusplus
}
