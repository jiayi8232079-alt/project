...
/**
* @brief    cloud operation free buffer for sleep
* @return   OPERATE_RET
* - OPRT_OK init success
* - Others  init failed
*/
OPERATE_RET cloud_operation_config_cache_reset(VOID);
/**
...
//for T5, make sure http one by one.
VOID cloud_operation_get_http_permit() ;
VOID cloud_operation_release_http_permit();
