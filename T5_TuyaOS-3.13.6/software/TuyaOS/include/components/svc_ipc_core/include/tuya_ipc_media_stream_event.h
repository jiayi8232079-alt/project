...
typedef enum
{
    ...
    MEDIA_STREAM_PLAYBACK_QUERY_DAY_TS_WITH_ENCRYPT ,            /* query storage info of day */
         MEDIA_STREAM_DOWNLOAD_START_WITH_ENCRYPT,
...
/**
 * \typedef MEDIA_STREAM_AI_RESULT_CB
 * \brief callback function when AI result is received
 * \param [in] result_list: AI result list, such as ["ai_package"]
 * \param [in] ai_msg: AI message
 * \param [in] ai_msg_time: AI message time
 */
typedef VOID (*MEDIA_STREAM_AI_RESULT_CB)(IN CHAR_T *result_list, IN CHAR_T *ai_msg, IN UINT_T ai_msg_time);
