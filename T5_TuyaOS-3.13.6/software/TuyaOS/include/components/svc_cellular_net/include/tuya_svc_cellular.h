/**
 * @file tuya_svc_cellular.h
 * @brief TUYA cellular service
 * @version 0.1
 * @date 2021-03-18
 *
...
#ifndef __TUYA_SVC_CELLULAR_H__
#define __TUYA_SVC_CELLULAR_H__
 ...
 */
OPERATE_RET tuya_svc_cellular_init(VOID);
 ...
 * @return OPRT_OK on success. Others on error, please refer to tuya_error_code.h
 */
OPERATE_RET tuya_svc_cellular_register_netstat_cb(GET_NW_STAT_CB cb);

#ifdef __cplusplus
}
#endif

#endif //__TUYA_SVC_CELLULAR_H__
