 ...
 * @LastEditTime: 2024-07-31 11:35:36
 */
...
#define PR_ERR(format, args...)                                                 \
    printf("[%s][ERROR  ]%s[%s][%s:%d]:" format, GET_TIME_STR(), LOG_TAG,       \
            filename(__FILE__), __func__, (int)__LINE__, ##args); printf("\n")
#endif /** !PR_ERR */

#ifndef PR_WARN
#define PR_WARN(format, args...)                                                \
    printf("[%s][WARNING]%s[%s][%s:%d]:" format, GET_TIME_STR(), LOG_TAG,       \
            filename(__FILE__), __func__, (int)__LINE__, ##args); printf("\n")
#endif /** !PR_WARN */

#ifndef PR_NOTICE
#define PR_NOTICE(format, args...)                                              \
    printf("[%s][NOTICE ]%s[%s][%s:%d]:" format, GET_TIME_STR(), LOG_TAG,       \
            filename(__FILE__), __func__, (int)__LINE__, ##args); printf("\n")
#endif /** !PR_NOTICE */

#ifndef PR_INFO
#define PR_INFO(format, args...)                                                \
    printf("[%s][INFO   ]%s[%s][%s:%d]:" format, GET_TIME_STR(), LOG_TAG,       \
            filename(__FILE__), __func__, (int)__LINE__, ##args); printf("\n")
#endif /** !PR_INFO */
...
#define PR_DEBUG(format, args...)                                               \
    printf("[%s][DEBUG  ]%s[%s][%s:%d]:" format, GET_TIME_STR(), LOG_TAG,       \
            filename(__FILE__), __func__, (int)__LINE__, ##args); printf("\n")
