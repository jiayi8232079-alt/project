...
/**
 * @brief Set the active linkage to the specified type
 *
 * @param[in] type linkage type to set as active, see LINKAGE_TYPE_E
 *
 * @return OPRT_OK on success. Others on error, please refer to tuya_error_code.h
 */
OPERATE_RET tuya_svc_netmgr_linkage_set_active(IN LINKAGE_TYPE_E type);
