...
#define GP_DEV_PLC DEV_PLC_SNGL           // plc
...
#define GP_DEV_SUPPORT_MAX GP_DEV_PLC // max attach id
...
/* Matter OTA */
#define UPGRADE_TYPE_MATTER 3
/* Matter OTA over ATOP */
#define UPGRADE_TYPE_MATTER_OVER_ATOP 4
...
typedef enum {
    ...
    GW_UNREGISTER_CLOUD_SERVICE,//notify tuya cloud services,such as: mqc, upgrade, timer to unregister
} GW_RESET_TYPE_E;
