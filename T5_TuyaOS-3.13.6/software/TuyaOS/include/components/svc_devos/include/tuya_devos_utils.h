...
OPERATE_RET gw_user_token_bind_by_linkage(LINKAGE_TYPE_E type, IN CONST CHAR_T *token);
...
#if defined(ENABLE_STATIC_IP) && (ENABLE_STATIC_IP == 1) 
OPERATE_RET gw_get_static_ip(OUT CHAR_T * static_ip_str);
OPERATE_RET gw_set_static_ip(IN CONST CHAR_T * static_ip_str);
#endif
#ifdef __cplusplus
}
#endif
