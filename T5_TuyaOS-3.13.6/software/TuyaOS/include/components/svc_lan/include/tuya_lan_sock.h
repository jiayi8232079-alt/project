 ...
 *
 */
typedef VOID (*sloop_sock_read)(INT_T sock, void *args);

/**
 * @brief pre select handler
 *
 */
typedef VOID (*sloop_sock_pre_select)(void *args);
 ...
 *
 */
typedef VOID (*sloop_sock_err)(INT_T sock, void *args);

/**
 * @brief sock loop thread quit handler
 *
 */
typedef VOID (*sloop_sock_quit)(void *args);
