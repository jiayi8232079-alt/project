...
#define EVENT_TIMER_TASK_UPDATE "timertask.update" // timer task update
#define EVENT_BEFORE_RESET       "dev.before.reset"  // device beforereset
...
#define EVENT_WIFI_NETWORK_STATUS   "wifi.net.stat" // wifi network status for ffs ble
//wifi low power notify
#define EVENT_LOWPOWER_NOTIFY  "lowpower.notify" // wifi low power notify
...
//matter
#define EVENT_MATTER_COMMISSION_COMPLETE    "commiss.compl" // matter commission complete
#define EVENT_FLASH_PROTECT_RECOVERY        "protect.recov" // flash protect recovery
