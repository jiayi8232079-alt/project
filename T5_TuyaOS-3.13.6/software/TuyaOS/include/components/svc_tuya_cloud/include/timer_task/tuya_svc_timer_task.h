...
/**
 * @brief Get the list of timer task.
 *
 * @param VOID
 *
 * @note use tuya_svc_timer_get_capacity or tuya_svc_timer_get_num to get valid count of timer task first.
 * @return the list of timer task.
 */
ALARM_TIMER_S *tuya_svc_timer_get_list(VOID_T);
