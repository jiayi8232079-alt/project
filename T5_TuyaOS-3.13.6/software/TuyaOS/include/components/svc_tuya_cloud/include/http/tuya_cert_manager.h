 ...
 */
OPERATE_RET tuya_iot_store_third_cloud_ca(CHAR_T *p_url, CONST UCHAR_T *ca_data, UINT_T ca_data_len, BOOL_T need_base64_decode);
 ...
 *
 */
typedef OPERATE_RET (*TUYA_CERT_SAVE_CB)(CHAR_T *url, UCHAR_T *ca, UINT_T len);
 ...
 *
 */
typedef BOOL_T (*TUYA_CERT_RESTORE_CB)(VOID *p_ctx, CHAR_T *url);
