...
/**
 * @brief disable the dns cache, use system dns always
 *
 * @param[in] disable TRUE: disable the dns cache, FALSE: enable the dns cache
 *
 * @note default state is FALSE
 */
VOID unw_disable_dns_cache2db(BOOL_T disable);


/**
 * @brief always use system dns
 */
VOID unm_set_dns_force_system(VOID);
