...
/**
 * @brief pack array flow data
 *
 * @param[in] map_array_body array flow data
 * @param[in] map_array_body_len data length
 * @param[out] out_data out data
 * @param[out] out_len out data length
 *
 * @return OPRT_OK on success. Others on error, please refer to tuya_error_code.h
...
OPERATE_RET mqc_pack_map_array_flow_data(IN CONST CHAR_T *map_array_body, IN CONST UINT_T map_array_body_len ,OUT BYTE_T **out_data, OUT UINT_T *out_len);
