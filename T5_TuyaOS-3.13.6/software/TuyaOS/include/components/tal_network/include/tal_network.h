...
/**
 * @brief Listen for readable events on a single file descriptor using epoll
 * 
 * @param fd File descriptor to listen on
 * @param ms_timeout Timeout value in milliseconds; -1 for blocking, 0 for immediate return
 * @return
 *   On success: Returns 1, indicating the file descriptor is readable
 *   On timeout: Returns 0, indicating a timeout
 *   On error: Returns -1, and sets errno
 */
INT_T tal_net_epoll_r1(INT_T fd , INT_T ms_timeout);
