...
#define tuya_debug_hex_dump_with_time(title, width, buf, size)       \
     tal_log_hex_dump_with_time(TAL_LOG_LEVEL_DEBUG, _THIS_FILE_NAME_, __LINE__, title, width, buf, size)
...
TAL_PRINTF_CHECK(1, 2) OPERATE_RET PrintErrLog(CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(1, 2) OPERATE_RET PrintWarnLog(CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(1, 2) OPERATE_RET PrintInfoLog(CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(1, 2) OPERATE_RET PrintNoticeLog(CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(1, 2) OPERATE_RET PrintDebugLog(CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(1, 2) OPERATE_RET PrintTraceLog(CONST CHAR_T* pFmt,...);
...
TAL_PRINTF_CHECK(2, 3) OPERATE_RET PrintErrLog(CONST CHAR_T* pFile, CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(2, 3) OPERATE_RET PrintWarnLog(CONST CHAR_T* pFile, CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(2, 3) OPERATE_RET PrintInfoLog(CONST CHAR_T* pFile, CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(2, 3) OPERATE_RET PrintNoticeLog(CONST CHAR_T* pFile, CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(2, 3) OPERATE_RET PrintDebugLog(CONST CHAR_T* pFile, CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(2, 3) OPERATE_RET PrintTraceLog(CONST CHAR_T* pFile, CONST CHAR_T* pFmt,...);
...
#else
TAL_PRINTF_CHECK(3, 4) OPERATE_RET PrintErrLog(CONST CHAR_T* pFile, UINT_T line, CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(3, 4) OPERATE_RET PrintWarnLog(CONST CHAR_T* pFile, UINT_T line, CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(3, 4) OPERATE_RET PrintInfoLog(CONST CHAR_T* pFile, UINT_T line, CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(3, 4) OPERATE_RET PrintNoticeLog(CONST CHAR_T* pFile, UINT_T line, CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(3, 4) OPERATE_RET PrintDebugLog(CONST CHAR_T* pFile, UINT_T line, CONST CHAR_T* pFmt,...);
TAL_PRINTF_CHECK(3, 4) OPERATE_RET PrintTraceLog(CONST CHAR_T* pFile, UINT_T line, CONST CHAR_T* pFmt,...);
