...
if [ ! -f ${app_config_file} ]; then
    echo "not found app resource config, use default"
    app_config_file=${TUYA_PROJECT_DIR}/vendor/T5/t5_os/projects/tuya_app/tuya_scripts/app_resource_defconfig.json
fi
