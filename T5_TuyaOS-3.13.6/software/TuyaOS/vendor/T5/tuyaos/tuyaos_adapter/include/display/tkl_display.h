...
typedef struct
{
    INT_T mode;        // ref TKL_DISP_BLIGHT_E
    TUYA_GPIO_NUM_E io;
...
typedef struct
{
    ...
    TKL_DISP_BL_CONF_S bl;              // ugly
    TKL_DISP_BL_CONF_S bl1;

    TKL_DISP_SPI_CONF_S spi;
    TKL_DISP_SPI_CONF_S spi1;

    TUYA_GPIO_NUM_E power_ctrl_pin;
    TUYA_GPIO_LEVEL_E power_active_level;
    TUYA_GPIO_NUM_E power_ctrl_pin1;
    TUYA_GPIO_LEVEL_E power_active_level1;

    TUYA_GPIO_NUM_E rst_pin;
    TUYA_GPIO_LEVEL_E rst_active_level;
    TUYA_GPIO_NUM_E rst_pin1;
    TUYA_GPIO_LEVEL_E rst_active_level1;

    TUYA_GPIO_NUM_E dc_pin;
    TUYA_GPIO_LEVEL_E dc_cmd_level;
    TUYA_GPIO_NUM_E dc_pin1;
    TUYA_GPIO_LEVEL_E dc_cmd_level1;

    BOOL_T  spi_using_qspi;

    TKL_DISP_PIXEL_FMT_E rgb_mode;
    INT8_T ic_name[IC_NAME_LENGTH];
    UINT32_T deivce_ppi;
    TKL_DISP_TP_CONF_S tp;
    INT_T enable_lcd_pipeline;
