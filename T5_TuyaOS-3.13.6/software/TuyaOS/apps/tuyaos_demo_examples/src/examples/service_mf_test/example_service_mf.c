...
#define MF_UART_ID  TUYA_UART_NUM_0
 ...
 */
STATIC OPERATE_RET __mf_user_basic_test_callback(USHORT_T cmd, UCHAR_T *data, UINT_T len)
{
    char buf[24]= {0};
...
VOID example_mf_init(INT_T argc, CHAR_T *argv[])
{
    ...
    MF_IMPORT_INTF_S _mf_intf = {
        ...
        .mf_user_basic_test = __mf_user_basic_test_callback,
