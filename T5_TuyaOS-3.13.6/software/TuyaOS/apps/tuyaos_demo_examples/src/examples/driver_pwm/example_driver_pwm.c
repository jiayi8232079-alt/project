...
STATIC VOID __example_pwm_task(VOID* param)
{
    ...
    // 如果不清楚 pin 对应的 pwm id，可以通过 tkl_pinmux.c 文件中的 tkl_io_pin_to_func 函数获取
    // If the PWM ID corresponding to the pin is not clear, it can be obtained through
    // the tkl_io_pin_to_func function in the tkl_pinmux.c file.
