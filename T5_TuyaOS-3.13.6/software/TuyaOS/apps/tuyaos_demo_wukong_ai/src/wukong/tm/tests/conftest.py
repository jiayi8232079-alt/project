"""Wukong TM C unit-test harness with TAP output parsing."""
...
_APP_SRC = (_TESTS_DIR / "../../..").resolve()  # apps/.../src/
_TM_DIR = _TESTS_DIR.parent
...
def c_test(tmp_path: Path) -> CTestHarness:
    """Provide a CTestHarness for C unit tests."""
